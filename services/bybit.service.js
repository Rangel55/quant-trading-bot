...
// --- Suporte a Proxy (para operar fora do Brasil) ---
// Configure no .env: PROXY_HOST, PROXY_PORT, PROXY_USER, PROXY_PASS
function buildAxiosConfig() {
    ...
    if (proxyHost && proxyPort) {
          ...
          console.log('[PROXY] Usando proxy: ' + proxyHost + ':' + proxyPort);
    }
    return config;
}

const http = axios.create(buildAxiosConfig());
